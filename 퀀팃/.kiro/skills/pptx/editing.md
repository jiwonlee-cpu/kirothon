...
2. **Plan slide mapping**: For each content section, choose a template slide.
   ...
   ⚠️ **USE VARIED LAYOUTS** — monotonous presentations are a common failure mode. Actively seek out:
...
- **Longer replacements**: May overflow — test with visual QA after text changes
